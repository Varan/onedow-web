...
exports.WorkoutTimerStore = void 0;
...
var WorkoutTimerStore = /** @class */ (function () {
    function WorkoutTimerStore() {
        this.startTime = (0, dayjs_1.default)();
    ...
    WorkoutTimerStore.prototype.measure = function () {
        ...
        if (!this.isRunning)
            return;
        this.seconds = (0, dayjs_1.default)().diff(this.startTime, "second");
        setTimeout(function () { return _this.measure(); }, 10);
    };
    ...
    Object.defineProperty(WorkoutTimerStore.prototype, "percent", {
        get: function () {
            return "".concat(Math.min(100, this.seconds / 180), "%");
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(WorkoutTimerStore.prototype, "display", {
        get: function () {
            ...
            return "".concat(padZero(minutes), ":").concat(padZero(seconds));
        },
        enumerable: false,
        configurable: true
    });
